...
public class NumbersFcActivity extends AppCompatActivity implements View.OnClickListener {
    TextView tv1;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numbers_fc);
        ...
        collection.setCategory("Numbers");
    ...
    private void speakWord() {
        if (currentQuestion != null && !tv1.getText().toString().equals("No more FlashCards")) {
            // Speak the French word (the original word)
