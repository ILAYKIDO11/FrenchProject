...
public class TestNumbers extends AppCompatActivity implements View.OnClickListener {
    ...
    String apiUrl = "https://mocki.io/v1/cfda2705-0d08-487a-9cd3-fe24e3b770e3";
    ...
    private void loadQuestionsFromAPI() {
        ...
        if (result != null && result.length() > 2) {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(TestNumbers.this, "Error parsing the question data.", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(TestNumbers.this, "Error: No data found.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void loadNewQuestion() {
        if (remainingQuestions.size() > 0) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(TestNumbers.this, "Error loading new question.", Toast.LENGTH_SHORT).show();
            }
        } else {
            disableButtons();
