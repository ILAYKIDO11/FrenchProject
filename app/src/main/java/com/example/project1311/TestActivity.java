...
public class TestActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    String apiUrl = "https://mocki.io/v1/bc76062c-20a7-438b-8659-d58cff21b6c8";
    ...
    public static class XMarkView extends View {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            // Measure and draw both paths based on progress
    ...
    private void loadQuestionsFromAPI() {
        ...
        if (result != null && result.length() > 2) {
            try {
                ...
                e.printStackTrace();
                Toast.makeText(TestActivity.this, "Error parsing the question data.", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(TestActivity.this, "Error: No data found.", Toast.LENGTH_SHORT).show();
        }
    }
    ...
    private void loadNewQuestion() {
        if (remainingQuestions.size() > 0) {
            ...
            try {
                ...
                e.printStackTrace();
                Toast.makeText(TestActivity.this, "Error loading new question.", Toast.LENGTH_SHORT).show();
            }
        } else {
            disableButtons();
